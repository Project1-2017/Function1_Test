 ...
 * {@link e_not.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link e_not#newInstance} factory method to
...
public class e_not extends Fragment {
     ...
     * @return A new instance of fragment e_not.
     */
    ...
    public void fetch_notifications_le(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.URL_ROOT,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONArray thread = res.getJSONArray("notifications_le");
                            for (int i = 0; i < thread.length(); i++) {
                                JSONObject obj = thread.getJSONObject(i);
                                int id = obj.getInt("id");
                                String name = obj.getString("tr_name");
                                String contact =obj.getString("tr_contact");
                                String email = obj.getString("tr_email");
                                String d_t = obj.getString("date_time");
                                String message = obj.getString("message");
                                String title = obj.getString("title");
                                notifications.add(new notification_item_le(d_t,name,message,email,contact,title,id));
                            }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("type","notifications_le");
...
class notification_item_le{
    ...
    int id,reply_status;
    notification_item_le(String date_time,String tr_name,String message, String email,String contact,String tr_title,int id){
